...
<div class="box">
<small>CHALLENGER EVIDENCE</small>
<big>{summary["training_ready_outcomes"]}/{summary["minimum_required"]}</big>
</div>

<div class="box">
<small>EVIDENCE-COLLECTOR PAPER ORDERS</small>
<big>0</big>
</div>

<div class="box">
<small>EVIDENCE-COLLECTOR LIVE ORDERS</small>
<big>0</big>
</div>

<div class="box">
<small>CHAMPION STATUS</small>
<big>PROTECTED</big>
</div>
</div>
</div>
...
<p>
SPY Sentinel has separately demonstrated a controlled Alpaca paper-trading
lifecycle. The zero-order counts above apply specifically to the evidence
collection and learning pipelines shown on this page.
</p>
...
<big>BLOCKED BY DESIGN</big>
</div>

<div class="box">
<small>NEXT GATE</small>
<big>INDEPENDENT VALIDATION</big>
</div>
...
<p class="sub">
Current status: evidence collection PROVEN, clean learning evidence READY,
independent validation NEXT, Champion protection ACTIVE.
Every arrow remains a gate.
</p>
</div>
