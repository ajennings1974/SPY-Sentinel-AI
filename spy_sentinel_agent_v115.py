...
PAPER_ORDER_ARMED = True

# COMPETITION DEMO MODE
# This does NOT mean a profitable strategy has been proven.
DEMO_PAPER_OVERRIDE = True
DEMO_MAX_COST = 250.00
...
# ------------------------------------------
# ONE-POSITION / ONE-ORDER DEMO GUARD
# ------------------------------------------

existing_positions_v115 = trading.get_all_positions()

try:
    existing_orders_v115 = trading.get_orders()
except Exception:
    existing_orders_v115 = []

demo_account_clear_v115 = (
    len(existing_positions_v115) == 0
    and len(existing_orders_v115) == 0
)

print("\nDEMO ACCOUNT GUARD")
print("Existing positions:", len(existing_positions_v115))
print("Existing orders:", len(existing_orders_v115))
print("Account clear:", demo_account_clear_v115)
...
all_execution_gates_v99 = (
    ...
    and (RESEARCH_EDGE_PROVEN or DEMO_PAPER_OVERRIDE)
    and EXECUTION_ENABLED
    and PAPER_ORDER_ARMED
    and cost_pass_v99
    and estimated_cost_v99 <= DEMO_MAX_COST
    and demo_account_clear_v115
...
print("Candidate exists:", candidate is not None)
print("Demo override:", DEMO_PAPER_OVERRIDE)
print("Execution enabled:", EXECUTION_ENABLED)
print("Paper armed:", PAPER_ORDER_ARMED)
print("Cost gate:", cost_pass_v99)
print("Estimated cost:", estimated_cost_v99 if candidate else None)
print("Demo max cost:", DEMO_MAX_COST)
print("Account clear:", demo_account_clear_v115)
print("Live disabled:", not LIVE_TRADING_ENABLED)
